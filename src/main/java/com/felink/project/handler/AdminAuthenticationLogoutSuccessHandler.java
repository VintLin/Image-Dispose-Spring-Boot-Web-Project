...
@Component
public class AdminAuthenticationLogoutSuccessHandler implements LogoutSuccessHandler {
    ...
    public void onLogoutSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        ResponseJSON responseJSON = new ResponseJSON(200, "logout success", data);
