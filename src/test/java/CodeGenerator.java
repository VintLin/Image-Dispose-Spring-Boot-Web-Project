import com.felink.project.core.ProjectConstant;
...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/image_dispose";
    ...
    public static void genService(String tableName, String modelName) {
        try {
            ...
            cfg.getTemplate("transitions.ftl").process(data, new FileWriter(file));
            ...
            cfg.getTemplate("transitions-impl.ftl").process(data,
